...
DEFAULTS = {
    'CLIENT_ID_GENERATOR_CLASS': 'oauth2.generators.ClientIdGenerator',
    'CLIENT_SECRET_GENERATOR_CLASS': 'oauth2.generators.ClientSecretGenerator',
    'OAUTH2_VALIDATOR_CLASS': 'oauth2.oauth2_validators.OAuth2Validator',
    'SCOPES': {"read": "Reading scope", "write": "Writing scope"},
    'READ_SCOPE': 'read',
    'WRITE_SCOPE': 'write',
    'AUTHORIZATION_CODE_EXPIRE_SECONDS': 60,
    'ACCESS_TOKEN_EXPIRE_SECONDS': 36000,
    'APPLICATION_MODEL': getattr(settings, 'OAUTH2_PROVIDER_APPLICATION_MODEL', 'oauth2.Application'),
    'REQUEST_APPROVAL_PROMPT': 'confirmed',#权限一样已经登陆，自动条转 force ,auto
